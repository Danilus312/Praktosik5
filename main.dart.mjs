...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      cH: x0 => x0.value,
      cI: x0 => x0.getAllResponseHeaders(),
      d: (o, p) => o[p],
      ...
      gI: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      ...
      hI: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      i: (l, r) => l === r,
      ...
      lI: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      m: () => globalThis.Math,
      ...
      mH: () => new TextDecoder(),
      mI: (x0,x1) => { x0.withCredentials = x1 },
