...
final List<Reader> seedReaders = [
  Reader(
    ...
    card: LibraryCard(
        cardNumber: 'LC-1001', issuedAt: DateTime(2025, 1, 15), isActive: true),
  ),
  Reader(
    id: 2,
    ...
    card: LibraryCard(
        cardNumber: 'LC-1002', issuedAt: DateTime(2025, 2, 20), isActive: true),
  ),
];

final Map<int, String> genreMap = {for (var g in seedGenres) g.id: g.name};
final Map<int, String> publisherMap = {
  for (var p in seedPublishers) p.id: p.name
};
